                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="text" class="form-control" name="ma_nv"
                                        value="{{ old('ma_nv') }}" required maxlength="20" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="text" class="form-control" name="ho_ten"
                                        value="{{ old('ho_ten') }}" required maxlength="191" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="text" class="form-control" name="dia_chi_thuong_tru" required
                                        maxlength="191" value="{{ old('dia_chi_thuong_tru') }}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="md-radio-inline">
                                    <div class="md-radio">
                                        <input type="radio" id="checkbox1" name="gioi_tinh" value="1"
                                            class="md-radiobtn" <?php if (old('gioi_tinh')) {
                                                echo old('gioi_tinh') == '1' ? 'checked' : '';
                                            } else {
                                                echo 'checked';
                                            } ?>>
                                        <label for="checkbox1">
                                    ...
                                    <div class="md-radio">
                                        <input type="radio" id="checkbox2" name="gioi_tinh" value="0"
                                            class="md-radiobtn" <?php echo old('gioi_tinh') == '0' ? 'checked' : ''; ?>>
                                        <label for="checkbox2">
                                            <span class="inc"></span>
                                            <span class="check"></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input class="form-control" name="ngay_sinh" id="ngay_sinh" type="text"
                                        placeholder="dd-mm-yyyy" required value="{{ old('ngay_sinh') }}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="text" class="form-control" name="so_cmnd" required
                                        value="{{ old('so_cmnd') }}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    <i class="fa fa-calendar"></i>
                                    <input class="form-control" name="ngay_cap_cmnd" id="ngay_cap_cmnd"
                                        type="text" placeholder="dd-mm-yyyy" value="{{ old('ngay_cap_cmnd') }}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="text" class="form-control" name="noi_cap_cmnd"
                                        value="{{ old('noi_cap_cmnd') }}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    <i class="fa fa-calendar"></i>
                                    <input class="form-control" name="ngay_bat_dau_lam" id="ngay_bat_dau_lam"
                                        type="text" placeholder="dd-mm-yyyy"
                                        value="{{ old('ngay_bat_dau_lam') }}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    <i class="fa fa-calendar"></i>
                                    <input class="form-control" name="ngay_lam_viec_cuoi" id="ngay_lam_viec_cuoi"
                                        type="text" placeholder="dd-mm-yyyy"
                                        value="{{ old('ngay_lam_viec_cuoi') }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-icon right">
                                    ...
                                    <input type="text" class="form-control" name="nam_tot_nghiep"
                                        value="{{ old('nam_tot_nghiep') }}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                                    ...
                                    <select class="form-control" name="phongban_id">
                                        ...
                                        @if ($ds_phong_ban->count() > 0)
                                            @foreach ($ds_phong_ban as $v)
                                                <option value="{{ $v->id }}" <?php echo old('phongban_id') == $v->id ? 'selected' : ''; ?>>
                                                    {{ $v->ten }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="icheck-inline">
                                @foreach ($ds_ho_so as $v)
                                    <label class="col-md-3 col-xs-6" style="margin: 0 0 10px 0;">
                                        <input type="checkbox" name="hoso_id[]" value="{{ $v->id }}"
                                            data-checkbox="icheckbox_minimal-blue" type="checkbox" class="icheck">
                                        {{ $v->ten }} </label>
                                @endforeach
                            </div>
                        @endif
