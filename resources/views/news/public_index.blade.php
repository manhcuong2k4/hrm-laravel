        ...
        <div class="container">
            <div class="row g-4 mb-4">
                <div class="col-lg-4">
                    ...
                    <p>Giải pháp quản lý nhân sự thông minh, tích hợp AI và phân tích dữ liệu cho doanh nghiệp công
                        nghệ.</p>
            ...
            <div class="text-center pt-3">
                <p class="mb-0">© 2024 <strong>DataTech</strong>. All Rights Reserved. Designed with <i
                        class="bi bi-heart-fill text-danger"></i> by DataTech Team</p>
            </div>
        </div>
    </footer>
